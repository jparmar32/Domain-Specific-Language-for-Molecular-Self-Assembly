...
msbTrans = tam3.TileTemplate(name="msbTrans")
interiorTrans = tam3.TileTemplate(name="interiorTrans")
lsbTrans = tam3.TileTemplate(name="lsbTrans")
...
msbTransSeed = tam3.TileTemplate("msbTransSeed")
interiorTransSeed = tam3.TileTemplate("interiorTransSeed")
lsbTransSeed = tam3.TileTemplate("lsbTransSeed")
interiorFlipperSeed = tam3.TileTemplate("interiorFlipperSeed")
msbFlipperSeed = tam3.TileTemplate("msbFlipperSeed")
...
lsbPortTop = tam3.TileTemplate(name="lsbPortTop")
msbPortTop = tam3.TileTemplate(name="msbportTop")
interiorPortTop = tam3.TileTemplate(name="intPortTop")
msbTransTop = tam3.TileTemplate("msbTransTop")
intTransTop = tam3.TileTemplate("intTransTop")
lsbTransTop = tam3.TileTemplate("lsbTransTop")
def createTopGrowMod(name,tst):
    ...
    return topGrowMod
msbStartSeed = tam3.TileTemplate("msbStartSeed")
intStartSeed = tam3.TileTemplate("intStartSeed")
lsbStartSeed = tam3.TileTemplate("lsbStartSeed")
intFlipStartSeed = tam3.TileTemplate("intFlipStartSeed")
msbFlipStartSeed = tam3.TileTemplate("msbFlipStartSeed")
...
msbPortFrom = tam3.initiatorPort("msbPortFrom", 2, False)
interiorPortFrom = tam3.Port("interorPortFrom")
lsbPortFrom = tam3.Port("lsbPortFrom")

#To Ports for left transition Module
msbPortTo = tam3.initiatorPort("msbPortTo", 2, True)
interiorPortTo = tam3.Port("interorPortTo")
lsbPortTo = tam3.Port("lsbPortTo")
...
lsbFlipPortFrom = tam3.initiatorPort("lsbFlipPortFrom", 2, False)
interiorFlipPortFrom = tam3.Port("interiorFlipPortFrom")
msbFlipPortFrom = tam3.Port("msbFlipPortFrom")

#To Ports for Top Grow Module
lsbFlipPortTo = tam3.initiatorPort("lsbFlipPortTo", 2, True)
interiorFlipPortTo = tam3.Port("interiorFlipPortTo")
msbFlipPortTo = tam3.Port("msbFlipPortTo")
...
msbTopPortFrom = tam3.initiatorPort("msbTopPortFrom", 2, False)
interiorTopPortFrom = tam3.Port("interiorTopPortFrom")
lsbTopPortFrom = tam3.Port("lsbTopPortFrom")

#To Ports for Right Transition Module
msbTopPortTo = tam3.initiatorPort("msbTopPortTo", 2, True)
interiorTopPortTo = tam3.Port("interiorTopPortTo")
lsbTopPortTo = tam3.Port("lsbTopPortTo")
...
msbRightTransPort = tam3.initiatorPort("msbRightTransPort", 2, False)
intRightTransPort = tam3.Port("intRightTransPort")
lsbRightTransPort = tam3.Port("lsbRightTransPort")

#Bottom Right Square Module To Ports
msbBotRightPort = tam3.initiatorPort("msbBotRightPort", 2, True)
intBotRightPort = tam3.Port("intBotRightPort")
lsbBotRightPort = tam3.Port("lsbBotRightPort")
